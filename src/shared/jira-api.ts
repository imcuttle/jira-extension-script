/**
 * Forked from https://github.com/jira-node/node-jira-client/blob/master/src/jira.js
 * 改造支持 axios
 */
...
export default class JiraApi {
  ...
  private host: any
  private greenhopperVersion: any
   ...
   */
  makeUri({ pathname, query, intermediatePath, encode = false }: any) {
   ...
   */
  makeWebhookUri({ pathname, intermediatePath }: any) {
    const intermediateToUse = this.intermediatePath || intermediatePath
   ...
   */
  makeSprintQueryUri({ pathname, query, intermediatePath }: any) {
    const intermediateToUse = this.intermediatePath || intermediatePath
   ...
   */
  makeDevStatusUri({ pathname, query, intermediatePath }: any) {
    const intermediateToUse = this.intermediatePath || intermediatePath
  ...
  async doRequest(requestOptions) {
    ...
    const response = (await this.request(options)) as any
